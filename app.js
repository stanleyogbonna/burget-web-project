...
let burgetController = (function() {
    ...
    return {
        addItem: function(type, des, val) {
            ...
            // Add new item to our data structure based on 'inc' or 'exp'
            if(type === 'inc'){
...
let UIController = (function() {
    ...
    return {
        ...
        displayExpensePerc: function(percentages) {
            let field = document.querySelectorAll(DOMstrings.expensePercentageLabel);
...
let controller = (function(burgetCtrl, UICtrl) {
    ...
    let updateBurget = function() {
        // 1. Calculate the budget.
        burgetCtrl.calculateBudget();

        // 2. Return burget
        let budget = burgetCtrl.getBudget();

        // 3. Display the budget on the UI.
        UICtrl.displayBurget(budget)
    };

    let updatePercentages = function() {
        // 1. Calculate percentages
        burgetCtrl.calculatePercentages();
        // 2. Read percentages from the budget controller
        let percentages = burgetCtrl.getPercentages();
    ...
    let ctrlAddItem = function() {
        ...
        newItem = burgetCtrl.addItem(input.type, input.description, input.value);
        ...
        // 5. Calculate burget and update burget in UI
        updateBurget();
